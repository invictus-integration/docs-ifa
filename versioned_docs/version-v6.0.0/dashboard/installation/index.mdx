...
| --------------------------------------- | ---- | --------- |
| `auditsCollectionThroughput`            | 1000 | No        |
| `dashboardSettingsCollectionThroughput` | 1000 | No        |
| `flowDataCollectionThroughput`          | 2000 | Yes       |
| `folderFlowsCollectionThroughput`       | 1000 | No        |
| `groupsCollectionThroughput`            | 1000 | No        |
| `messageContentCollectionThroughput`    | 2000 | Yes       |
| `statisticsCollectionThroughput`        | 1000 | No        |
| `usersCollectionThroughput`             | 1000 | No        |
