...
:::praise[recommended]
It is recommended to create a new `System Admin` user with your own email address after signing in for the first time. This will help during the [Forgot Password](../security/01_users.mdx#Forgot-Password) procedure.
:::
