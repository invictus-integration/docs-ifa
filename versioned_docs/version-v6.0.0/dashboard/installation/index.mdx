...
## Migrate to older installations
...
Each of the above parameters accepts an object with their options:
```json
{
...
| `unprocessedEventThreshold` | The target number of unprocessed events per worker for Event Hub-triggered functions. [Microsoft docs](https://learn.microsoft.com/en-us/dotnet/api/microsoft.azure.webjobs.eventhubs.eventhuboptions.targetunprocessedeventthreshold) |
...
* [Give access to your Active Directory](./01_give_ad_access.md)
* [Sync your Active Directory groups](./02_sync_ad_groups.md)
