...
If your Invictus installation integrates with Microsoft Entra ID, please follow the [Microsoft Entra ID setup guide](./01_give_ad_access.mdx) to update your app registration, or set up a new one with the appropriate settings required for Invictus V2.
