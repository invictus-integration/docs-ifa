...
Groups available in your Microsoft Entra ID will be used to determine whether users can access certain flows in the Invictus Dashboard. (See [flow permissions](../flows/01_add.mdx#flow-permissions)).
...
Once the groups are synced within the Dashboard, you have to manually enable the required groups which you want to use for [flow permissions](../flows/01_add.mdx#flow-permissions).
