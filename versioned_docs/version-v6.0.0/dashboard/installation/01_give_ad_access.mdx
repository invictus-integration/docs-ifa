...
Groups available in your Microsoft Entra ID will be used to determine whether users can access certain flows in the Invictus Dashboard. (See [flow permissions](../flows/01_add.mdx#permissions-)).
