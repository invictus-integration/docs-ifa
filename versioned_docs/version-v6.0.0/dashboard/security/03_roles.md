...
|          | Delete **user**                 |     🔴     |      🟢       | Removing a **local** or **Entra ID** user from accessing the Dashboard permanently (You need to remove **Entra ID** users from synced groups as well, if they're not allowed to sign back in) |
