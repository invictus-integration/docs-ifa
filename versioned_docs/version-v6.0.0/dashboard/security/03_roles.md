...
| -------- | -------------------------- | :----: | :------: | :----------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Flow     | View **flow** statuses     |   🟢    |    🟢     |      🟢       | [Accessing the homepage](../flows/index.mdx) and viewing the status summary of flows the user is assigned to                                                              |
...
| Messages | View **messages**          |   🟢    |    🟢     |      🟢       | [Searching for messages](../flows/02_search.mdx) for a selected flow the user is assigned to                                                                              |
