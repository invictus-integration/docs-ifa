...
|          | Delete **user**                 |     🔴     |      🟢       | Removing a **local** or **Entra ID** user from accessing the Dashboard permanently (**Entra ID** users will need to removed from synced groups as well, if they're not allowed to log back in) |
