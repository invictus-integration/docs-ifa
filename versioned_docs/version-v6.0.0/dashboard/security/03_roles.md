...
|          | Add **Microsoft Entra ID user** |     🟠     |      🟠       | 'Sign in with Microsoft Entra ID' on the sign in page automatically creates an user, when that user is a member of a [synced group](../installation/01_give_ad_access.mdx)                      |
