...
> 👤 Requires membership of a [synced Active Directory group](../installation/02_sync_ad_groups.md).
...
Before you can use the forgot password feature, you need to create an Azure Active Directory application registration and [set it up with the Mail.Send API permissions](../installation/01_give_ad_access.md). This is required because emails can only be sent through an OAuth 2.0 flow.
