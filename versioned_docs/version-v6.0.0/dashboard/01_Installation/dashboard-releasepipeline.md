...
- **Mandatory Arguments**
  ...
  - flowDataTTLInDays: A positive integer value which represents the amount of days flow data can live in the database. More info [here](../02_Flows/04_import-flow-traces/index.md).
