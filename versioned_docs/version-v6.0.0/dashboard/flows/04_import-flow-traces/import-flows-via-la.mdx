  ...
  <Collapsible title="Enable workflow diagnostics">
    ...
    * `EventHubsName`:
    ...
    <Tabs groupId="la">
      ...
      :::warning
      Make sure that the `Function Application Logs` diagnostic events is **✅ checked**, but the `AllMetrics` is **❌ unchecked**. Otherwise the app will send far to much events to the Event Hubs.
      :::
