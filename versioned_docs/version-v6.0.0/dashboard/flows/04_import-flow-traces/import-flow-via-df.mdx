---
sidebar_label: Import via Data Factory
hide_title: true
---
...
<ComponentHeader
  ...
  name="Data Factory import job"
  tagline="Import flow traces from Azure Data Factory pipelines" />
...
:::warning[required categories]
Make sure that the following categories are checked:
  * <FontAwesomeIcon icon={faSquareCheck} /> `PipelineRuns`
  * <FontAwesomeIcon icon={faSquareCheck} /> `TriggerRuns`
  * <FontAwesomeIcon icon={faSquareCheck} /> `ActivityRuns`
:::
