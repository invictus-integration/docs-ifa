---
sidebar_label: Import via Event Hubs
title: Import flow traces via Event Hubs
hide_title: true
---

import {OnlyFolderAdminsBadge, BadgedText} from '@site/src/components/Badges';
import ComponentHeader from '@site/src/components/ComponentHeader';

<ComponentHeader
  icon="/img/icons/import-jobs.png"
  name="Event Hubs import job"
  tagline="Import flow traces directly from Azure Event Hubs" />
...
## <BadgedText badge={<OnlyFolderAdminsBadge/>}>Map Dashboard flows to Event Hub receive events</BadgedText>
