---
sidebar_label: Import via HTTP
title: Import flow traces via HTTP
hide_title: true
---
...
<ComponentHeader
  ...
  name="HTTP import job"
  tagline="Import flow traces directly via HTTP" />
...
## <BadgedText badge={<OnlyFolderAdminsBadge/>}>Map Dashboard flows to HTTP receive events</BadgedText>
