...
> 👆 Clicking on the flow name redirects you to the details of that flow.
>
> 👆 Clicking on a status redirects you to the [search page](./02_search.mdx) to list all flows of that status. 
