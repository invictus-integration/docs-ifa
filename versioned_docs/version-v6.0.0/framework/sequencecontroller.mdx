...
The most minimal request body only contains the name of the sequence. This correlates all related workflows. Assuming this is the first workflow, it will receive number 1 in the response body; the second workflow will receive number 2, and so forth.
