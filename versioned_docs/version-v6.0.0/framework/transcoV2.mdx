...
The following Bicep parameters control the inner workings of the **Transco V2** component. See the [deployment of the Invictus Framework](./installation/index.mdx) to learn more.
