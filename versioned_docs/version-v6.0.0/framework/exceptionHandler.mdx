...
> See the [How to implement? section](#how-to-implement-ex-handler) to learn more about using this Framework component in Logic Apps setups.

## The `/ResolveException` endpoint
...
<details>
<summary><h3 id="how-to-implement-ex-handler" style={{ margin: 0 }}>How To Implement The Exception Handler in your Azure Logic Apps?</h3></summary>
...
<details>
<summary>**`Scope Exception Handling` Logic App JSON example**</summary>
