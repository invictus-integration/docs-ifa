...
The following Bicep parameters control the inner workings of the **Exception Handler** component. See the [deployment of the Invictus Framework](./installation/framework-releasepipeline.mdx) to learn more.
