...
Invictus includes network infrastructure to run resources within an Azure Virtual Network (VNET). Add these required resources to your deployment:

### An Azure Virtual Network
* Including two subnets, one each for:
  * Private Endpoints
  * Container App Environment
* Enable these services for each subnet:
