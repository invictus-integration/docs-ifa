...
| `useResourceLocks`                 |    No    | The flag to indicate whether the Azure resources for the Invictus product will be deployed with [resource locks](https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/lock-resources). |
