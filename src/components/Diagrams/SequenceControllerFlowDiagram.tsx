  ...
  return (
    <div style={{ maxWidth: 640, margin: "2rem auto" }}>
      ...
      >
        ...
        <text x="255" y="82" textAnchor="middle" dominantBaseline="middle" fontSize="9" fontWeight="700" letterSpacing="0.5" fill={C.rowTitle} style={{ fontFamily: BODY_FONT }}>
          HTTP
        </text>
        ...
        <line x1={125 + ACCENT_W + 3} y1="224" x2="271" y2="224" stroke={C.separator} strokeWidth="0.75" />
        ...
        <text x="233" y="184" textAnchor="middle" dominantBaseline="middle" fontSize="9" fontWeight="700" letterSpacing="0.5" fill={C.rowTitle} style={{ fontFamily: BODY_FONT }}>
          HTTP-callback
        </text>
        ...
        <text x="200" y="304" textAnchor="middle" dominantBaseline="middle" fontSize="13" fontWeight="600" fill={C.rowTitle} style={{ fontFamily: HEADING_FONT }}>
          Control task
        </text>
        ...
        <line x1={125 + ACCENT_W + 3} y1="428" x2="271" y2="428" stroke={C.separator} strokeWidth="0.75" />
        ...
        <text x="255" y="388" textAnchor="middle" dominantBaseline="middle" fontSize="9" fontWeight="700" letterSpacing="0.5" fill={C.rowTitle} style={{ fontFamily: BODY_FONT }}>
          HTTP
        </text>
