...
Once imported, messages become visible and searchable in the flow monitoring view.`}},u=["flow","flow-trace","flow-trace-importing"];function p({termKey:e,label:t,termClass:r,tooltipMarkdown:f,variant:m="technical"}){(0,l.n9)(),(0,o.useInsertionEffect)(()=>{let e="term-highlight-styles",t=document.getElementById(e);t||((t=document.createElement("style")).id=e,document.head.appendChild(t)),t.textContent=d},[]);let{colorMode:g}=(0,c.G)(),x="dark"===g,w=(0,o.useRef)(null),b=(0,o.useId)(),{visible:v,pinned:j,onMouseEnter:y,onMouseLeave:k,onFocus:_,onBlur:A,onClick:E,pin:C,onTooltipMouseEnter:T,onTooltipMouseLeave:I}=(0,l.DV)(w),M=(0,l._W)(w,v,{tooltipWidth:300}),[L,N]=(0,o.useState)(e);(0,o.useEffect)(()=>{v||N(e)},[v,e]);let z=u.indexOf(L),D=u[(z-1+u.length)%u.length],F=u[(z+1)%u.length],S=h[L],B=L===e?f:S.tooltipMarkdown,R=v&&(0,n.createPortal)((0,i.jsxs)("div",{id:b,role:"tooltip",className:`invictus-tooltip${j?" invictus-tooltip--pinned":""}`,"data-below":M.below?"true":"false",onMouseEnter:T,onMouseLeave:I,style:{position:"fixed",top:M.below?M.top:"auto",bottom:M.below?"auto":`calc(100vh - ${M.top}px)`,left:M.left,width:300,"--tooltip-accent":x?S.accentDark:S.accent},children:["technical"===m&&(0,i.jsxs)("div",{className:"invictus-tooltip__nav",children:[(0,i.jsx)("button",{className:"invictus-tooltip__nav-btn",onClick:e=>{e.stopPropagation(),C(),N(D)},"aria-label":`Previous: ${h[D].label}`,children:"\u2039"}),(0,i.jsxs)("span",{className:"invictus-tooltip__nav-label",children:[S.label,(0,i.jsxs)("span",{className:"invictus-tooltip__nav-pager",children:[z+1," / ",u.length]})]}),(0,i.jsx)("button",{className:"invictus-tooltip__nav-btn",onClick:e=>{e.stopPropagation(),C(),N(F)},"aria-label":`Next: ${h[F].label}`,children:"\u203A"})]}),(0,i.jsx)(s.oz,{remarkPlugins:[a.A],components:{a:({href:e,children:t})=>{let r=e?.startsWith("#")?e.slice(1):null,o=r?h[r]:null;return o?(0,i.jsx)("button",{className:"invictus-tooltip__term-link",style:{color:x?o.accentDark:o.accent,borderBottomColor:x?o.accentDark:o.accent},onClick:e=>{e.stopPropagation(),C(),N(r)},children:t}):(0,i.jsx)("a",{href:e,children:t})}},children:B}),(0,i.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:M.arrowLeft}})]}),document.body);return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)("span",{ref:w,className:`term-highlight ${r}`,tabIndex:0,role:"button","aria-pressed":j,"aria-describedby":v?b:void 0,onMouseEnter:y,onMouseLeave:k,onFocus:_,onBlur:A,onClick:E,children:[t,(0,i.jsx)("span",{className:"term-highlight__icon","aria-hidden":"true",children:"?"})]}),R]})}let f=`A **Flow** is a named message chain \u{2014} a logical grouping of related **mapping messages** sharing a common integration origin.

Flows are organized in *folders* and defined by a name, optional mappings, and business properties.`;function m({tooltip:e,variant:t="business"}){return(0,i.jsx)(p,{termKey:"flow",label:"flow",termClass:"term-highlight--flow",variant:t,tooltipMarkdown:e??("technical"===t?h.flow.tooltipMarkdown:f)})}function g({tooltip:e,variant:t="business"}){return(0,i.jsx)(p,{termKey:"flow",label:"flows",termClass:"term-highlight--flow",variant:t,tooltipMarkdown:e??("technical"===t?h.flow.tooltipMarkdown:f)})}function x({tooltip:e}){return(0,i.jsx)(p,{termKey:"flow-trace",label:"flow trace",termClass:"term-highlight--flow-trace",tooltipMarkdown:e??h["flow-trace"].tooltipMarkdown})}function w({tooltip:e}){return(0,i.jsx)(p,{termKey:"flow-trace",label:"flow traces",termClass:"term-highlight--flow-trace",tooltipMarkdown:e??h["flow-trace"].tooltipMarkdown})}},3937(e,t,r){r.d(t,{DV:()=>c,_W:()=>a,n9:()=>s});var i=r(6540);let o="u">typeof window?i.useLayoutEffect:i.useEffect,n=`
.invictus-tooltip {
  --tooltip-bg: #ffffff;
...
`;function s(){(0,i.useInsertionEffect)(()=>{let e="invictus-tooltip-styles",t=document.getElementById(e);t||((t=document.createElement("style")).id=e,document.head.appendChild(t)),t.textContent=n},[])}function a(e,t,{tooltipWidth:r=300,margin:o=12,navHeight:n=60,gap:s=10}={}){let[l,c]=(0,i.useState)({top:0,left:0,arrowLeft:14,below:!1}),d=(0,i.useCallback)(()=>{if(!e.current)return;let t=e.current.getBoundingClientRect(),i=window.innerWidth,a=t.left+t.width/2-r/2;a=Math.max(o,Math.min(a,i-r-o));let l=Math.min(Math.max(t.left+t.width/2-a,14),r-14),d=t.top-n<70;c({top:d?t.bottom+s:t.top-s,left:a,arrowLeft:l,below:d})},[e,r,o,n,s]);return(0,i.useLayoutEffect)(()=>{t&&d()},[t,d]),(0,i.useEffect)(()=>{if(t)return window.addEventListener("scroll",d,{passive:!0,capture:!0}),window.addEventListener("resize",d,{passive:!0}),()=>{window.removeEventListener("scroll",d,{capture:!0}),window.removeEventListener("resize",d)}},[t,d]),l}let l="invictus-tooltip-activate";function c(e){let[t,r]=(0,i.useState)(!1),[n,s]=(0,i.useState)(!1),[a,c]=(0,i.useState)(!1),[d,h]=(0,i.useState)(!1),u=(0,i.useRef)(null),p=(0,i.useRef)(`tip-${Math.random()}`),f=t||n||a||d,m=(0,i.useCallback)(()=>{clearTimeout(u.current),r(!1),s(!1),c(!1),h(!1)},[]),g=(0,i.useCallback)(()=>{document.dispatchEvent(new CustomEvent(l,{detail:{id:p.current}}))},[]);return o(()=>{if(!f)return;let e=e=>{e.detail.id!==p.current&&m()};return document.addEventListener(l,e),()=>document.removeEventListener(l,e)},[f,m]),(0,i.useEffect)(()=>{if(!f)return;let t=e=>{"Escape"===e.key&&m()},r=t=>{let r=e.current&&e.current.contains(t.target),i=t.target.closest?.(".invictus-tooltip");r||i||m()};return document.addEventListener("keydown",t),document.addEventListener("mousedown",r),()=>{document.removeEventListener("keydown",t),document.removeEventListener("mousedown",r)}},[f,m,e]),(0,i.useEffect)(()=>()=>clearTimeout(u.current),[]),{visible:f,pinned:d,onMouseEnter:()=>{clearTimeout(u.current),r(!0),g()},onMouseLeave:()=>{u.current=setTimeout(()=>r(!1),150)},onFocus:()=>{c(!0),g()},onBlur:()=>c(!1),onClick:()=>h(e=>!e),onTooltipMouseEnter:()=>{clearTimeout(u.current),s(!0)},onTooltipMouseLeave:()=>s(!1),pin:(0,i.useCallback)(()=>h(!0),[h])}}}}]);