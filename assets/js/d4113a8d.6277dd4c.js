...
`;function p(){return b({title:(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(c.gc,{icon:d.V2x})," Admins"]}),tooltip:"Only available for users with a **System Admin** role.",backgroundColor:"#b55d00",color:"white"})}function m(){return b({title:(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(c.gc,{icon:d.V2x})," Operators"]}),tooltip:"Only available for users with at least **Operator** permissions on the flow.",backgroundColor:"#b55d00",color:"white"})}function f(){return b({title:(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(c.gc,{icon:d.V2x})," Admins"]}),tooltip:"Only available for users with a **Folder** or **System Admin** role.",backgroundColor:"#b55d00",color:"white"})}function h({version:t,style:e}){return b({title:(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(c.gc,{icon:d.yy})," ",t]}),tooltip:`Feature included since **Invictus ${t}**.`,backgroundColor:"var(--inv-badge-new-bg)",color:"var(--inv-badge-new-text)",style:e})}function v({version:t,note:e,style:o}){return b({title:(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(c.gc,{icon:d.Dfk})," ",t]}),tooltip:`Feature deprecated since **Invictus ${t}**. ${e}`,backgroundColor:"var(--inv-badge-deprecated-bg)",color:"var(--inv-badge-deprecated-text)",style:o})}function g({variant:t}){return(0,r.useInsertionEffect)(()=>{let t="invictus-row-tint-styles",e=document.getElementById(t);e||((e=document.createElement("style")).id=t,document.head.appendChild(e)),e.textContent=u},[]),(0,n.jsx)("span",{"data-row-tint":t,"aria-hidden":"true",style:{display:"none"}})}function b({title:t,tooltip:e,backgroundColor:o,color:c,accentColor:d,style:u}){(0,a.n9)();let p=(0,r.useRef)(null),{descriptionId:m,descriptionEl:f,visible:h,pinned:v,onMouseEnter:g,onMouseLeave:x,onFocus:w,onBlur:y,onClick:j,tooltipEl:k}=function({badgeRef:t,tooltipContent:e,accentColor:o}){let s=(0,r.useId)(),{visible:l,pinned:c,onMouseEnter:d,onMouseLeave:u,onFocus:p,onBlur:m,onClick:f,onTooltipMouseEnter:h,onTooltipMouseLeave:v}=(0,a.DV)(t),g=(0,a._W)(t,l,{tooltipWidth:260}),b=(0,n.jsx)("span",{id:s,className:"invictus-sr-only",children:e}),x=l&&(0,i.createPortal)((0,n.jsxs)("div",{role:"tooltip",className:`invictus-tooltip${c?" invictus-tooltip--pinned":""}`,"data-below":g.below?"true":"false",onMouseEnter:h,onMouseLeave:v,style:{position:"fixed",top:g.below?g.top:"auto",bottom:g.below?"auto":`calc(100vh - ${g.top}px)`,left:g.left,width:260,"--tooltip-accent":o},children:[e,(0,n.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:g.arrowLeft}})]}),document.body);return{descriptionId:s,descriptionEl:b,visible:l,pinned:c,onMouseEnter:d,onMouseLeave:u,onFocus:p,onBlur:m,onClick:f,tooltipEl:x}}({badgeRef:p,tooltipContent:"string"==typeof e?(0,n.jsx)(s.oz,{remarkPlugins:[l.A],children:e}):e,accentColor:d??o});return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("span",{ref:p,style:{position:"relative",display:"inline-block",textTransform:"none",fontWeight:"normal",...u},role:"button","aria-pressed":v,"aria-describedby":m,onMouseEnter:g,onMouseLeave:x,onFocus:w,onBlur:y,onClick:j,children:(0,n.jsx)("span",{tabIndex:0,className:"invictus-badge",style:{backgroundColor:o,color:c,padding:"4px 8px",borderRadius:"4px",fontSize:"1rem",fontWeight:"600",fontFamily:"Inter",cursor:"help",userSelect:"none",borderBottom:"1.5px dotted currentColor","--badge-accent":d??o,...u},children:t})}),f,k]})}let x=(0,n.jsxs)(n.Fragment,{children:["Same for both ",(0,n.jsx)("strong",{children:"Dashboard"})," and ",(0,n.jsx)("strong",{children:"Framework"}),". Can be skipped if done already."]});function w(){return b({title:"Shared",tooltip:x,backgroundColor:"var(--inv-badge-shared-bg)",color:"var(--inv-badge-shared-text)",accentColor:"var(--inv-badge-shared-text)"})}function y({children:t,badge:e,variant:o="underline"}){let i=(0,r.useRef)(null),[a,s]=(0,r.useState)();(0,r.useEffect)(()=>{let t=i.current;if(!t)return;let e=()=>{let e=t.querySelector(".invictus-badge");if(!e)return!1;let o=window.getComputedStyle(e),n=o.getPropertyValue("--badge-accent").trim()||o.backgroundColor;return!!n&&"transparent"!==n&&"rgba(0, 0, 0, 0)"!==n&&(s(n),!0)};if(e())return;let o=new MutationObserver(()=>{e()&&o.disconnect()});return o.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),()=>o.disconnect()},[e]);let l="background"==o?((t,e=.1)=>{if(!t)return;let o=Math.round(100*e);return`color-mix(in srgb, ${t} ${o}%, transparent)`})(a,.1):void 0;return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("span",{style:{textDecoration:"underline dotted",textDecorationColor:a,backgroundColor:l,padding:"0.25rem"},children:t}),(0,n.jsx)("span",{ref:i,children:e})]})}},2284(t,e,o){o.d(e,{A:()=>r});var n=o(4848);o(6540);function r({icon:t,name:e,tagline:o}){return(0,n.jsxs)("div",{className:"header_Rs1Y",children:[(0,n.jsx)("div",{className:"iconBlock_flcq",children:(0,n.jsx)("img",{src:t,alt:""})}),(0,n.jsxs)("div",{className:"meta_kVky",children:[(0,n.jsx)("h1",{children:e}),(0,n.jsx)("p",{className:"tagline_Z4Kj",children:o})]})]})}},3937(t,e,o){o.d(e,{DV:()=>c,_W:()=>s,n9:()=>a});var n=o(6540);let r="u">typeof window?n.useLayoutEffect:n.useEffect,i=`
.invictus-tooltip {
  --tooltip-bg: #ffffff;
...
`;function a(){(0,n.useInsertionEffect)(()=>{let t="invictus-tooltip-styles",e=document.getElementById(t);e||((e=document.createElement("style")).id=t,document.head.appendChild(e)),e.textContent=i},[])}function s(t,e,{tooltipWidth:o=300,margin:r=12,navHeight:i=60,gap:a=10}={}){let[l,c]=(0,n.useState)({top:0,left:0,arrowLeft:14,below:!1}),d=(0,n.useCallback)(()=>{if(!t.current)return;let e=t.current.getBoundingClientRect(),n=window.innerWidth,s=e.left+e.width/2-o/2;s=Math.max(r,Math.min(s,n-o-r));let l=Math.min(Math.max(e.left+e.width/2-s,14),o-14),d=e.top-i<70;c({top:d?e.bottom+a:e.top-a,left:s,arrowLeft:l,below:d})},[t,o,r,i,a]);return(0,n.useLayoutEffect)(()=>{e&&d()},[e,d]),(0,n.useEffect)(()=>{if(e)return window.addEventListener("scroll",d,{passive:!0,capture:!0}),window.addEventListener("resize",d,{passive:!0}),()=>{window.removeEventListener("scroll",d,{capture:!0}),window.removeEventListener("resize",d)}},[e,d]),l}let l="invictus-tooltip-activate";function c(t){let[e,o]=(0,n.useState)(!1),[i,a]=(0,n.useState)(!1),[s,c]=(0,n.useState)(!1),[d,u]=(0,n.useState)(!1),p=(0,n.useRef)(null),m=(0,n.useRef)(`tip-${Math.random()}`),f=e||i||s||d,h=(0,n.useCallback)(()=>{clearTimeout(p.current),o(!1),a(!1),c(!1),u(!1)},[]),v=(0,n.useCallback)(()=>{document.dispatchEvent(new CustomEvent(l,{detail:{id:m.current}}))},[]);return r(()=>{if(!f)return;let t=t=>{t.detail.id!==m.current&&h()};return document.addEventListener(l,t),()=>document.removeEventListener(l,t)},[f,h]),(0,n.useEffect)(()=>{if(!f)return;let e=t=>{"Escape"===t.key&&h()},o=e=>{let o=t.current&&t.current.contains(e.target),n=e.target.closest?.(".invictus-tooltip");o||n||h()};return document.addEventListener("keydown",e),document.addEventListener("mousedown",o),()=>{document.removeEventListener("keydown",e),document.removeEventListener("mousedown",o)}},[f,h,t]),(0,n.useEffect)(()=>()=>clearTimeout(p.current),[]),{visible:f,pinned:d,onMouseEnter:()=>{clearTimeout(p.current),o(!0),v()},onMouseLeave:()=>{p.current=setTimeout(()=>o(!1),150)},onFocus:()=>{c(!0),v()},onBlur:()=>c(!1),onClick:()=>u(t=>!t),onTooltipMouseEnter:()=>{clearTimeout(p.current),a(!0)},onTooltipMouseLeave:()=>a(!1),pin:(0,n.useCallback)(()=>u(!0),[u])}}},8453(t,e,o){o.d(e,{R:()=>a,x:()=>s});var n=o(6540);let r={},i=n.createContext(r);function a(t){let e=n.useContext(i);return n.useMemo(function(){return"function"==typeof t?t(e):{...e,...t}},[e,t])}function s(t){let e;return e=t.disableParentContext?"function"==typeof t.components?t.components(r):t.components||r:a(t.components),n.createElement(i.Provider,{value:e},t.children)}}}]);