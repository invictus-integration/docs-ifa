...
Once imported, messages become visible and searchable in the flow monitoring view.`}},u=["flow","flow-trace","flow-trace-importing"];function p({termKey:e,label:t,termClass:r,tooltipMarkdown:f,variant:m="technical"}){(0,l.n9)(),(0,o.useInsertionEffect)(()=>{let e="term-highlight-styles",t=document.getElementById(e);t||((t=document.createElement("style")).id=e,document.head.appendChild(t)),t.textContent=d},[]);let{colorMode:g}=(0,c.G)(),x="dark"===g,b=(0,o.useRef)(null),w=(0,o.useId)(),{visible:v,pinned:j,onMouseEnter:y,onMouseLeave:k,onFocus:_,onBlur:A,onClick:C,pin:E,onTooltipMouseEnter:S,onTooltipMouseLeave:T}=(0,l.DV)(b),D=(0,l._W)(b,v,{tooltipWidth:300}),[I,L]=(0,o.useState)(e);(0,o.useEffect)(()=>{v||L(e)},[v,e]);let M=u.indexOf(I),N=u[(M-1+u.length)%u.length],z=u[(M+1)%u.length],F=h[I],B=I===e?f:F.tooltipMarkdown,q=v&&(0,n.createPortal)((0,i.jsxs)("div",{id:w,role:"tooltip",className:`invictus-tooltip${j?" invictus-tooltip--pinned":""}`,"data-below":D.below?"true":"false",onMouseEnter:S,onMouseLeave:T,style:{position:"fixed",top:D.below?D.top:"auto",bottom:D.below?"auto":`calc(100vh - ${D.top}px)`,left:D.left,width:300,"--tooltip-accent":x?F.accentDark:F.accent},children:["technical"===m&&(0,i.jsxs)("div",{className:"invictus-tooltip__nav",children:[(0,i.jsx)("button",{className:"invictus-tooltip__nav-btn",onClick:e=>{e.stopPropagation(),E(),L(N)},"aria-label":`Previous: ${h[N].label}`,children:"\u2039"}),(0,i.jsxs)("span",{className:"invictus-tooltip__nav-label",children:[F.label,(0,i.jsxs)("span",{className:"invictus-tooltip__nav-pager",children:[M+1," / ",u.length]})]}),(0,i.jsx)("button",{className:"invictus-tooltip__nav-btn",onClick:e=>{e.stopPropagation(),E(),L(z)},"aria-label":`Next: ${h[z].label}`,children:"\u203A"})]}),(0,i.jsx)(a.oz,{remarkPlugins:[s.A],components:{a:({href:e,children:t})=>{let r=e?.startsWith("#")?e.slice(1):null,o=r?h[r]:null;return o?(0,i.jsx)("button",{className:"invictus-tooltip__term-link",style:{color:x?o.accentDark:o.accent,borderBottomColor:x?o.accentDark:o.accent},onClick:e=>{e.stopPropagation(),E(),L(r)},children:t}):(0,i.jsx)("a",{href:e,children:t})}},children:B}),(0,i.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:D.arrowLeft}})]}),document.body);return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)("span",{ref:b,className:`term-highlight ${r}`,tabIndex:0,role:"button","aria-pressed":j,"aria-describedby":v?w:void 0,onMouseEnter:y,onMouseLeave:k,onFocus:_,onBlur:A,onClick:C,children:[t,(0,i.jsx)("span",{className:"term-highlight__icon","aria-hidden":"true",children:"?"})]}),q]})}let f=`A **Flow** is a named message chain \u{2014} a logical grouping of related **mapping messages** sharing a common integration origin.
