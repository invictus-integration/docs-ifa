...
`;function l(){(0,i.useInsertionEffect)(()=>{let t="invictus-tooltip-styles",e=document.getElementById(t);e||((e=document.createElement("style")).id=t,document.head.appendChild(e)),e.textContent=a},[])}function c(t,e,{tooltipWidth:o=300,margin:n=12,navHeight:r=60,gap:s=10}={}){let[a,l]=(0,i.useState)({top:0,left:0,arrowLeft:14,below:!1}),d=(0,i.useCallback)(()=>{if(!t.current)return;let e=t.current.getBoundingClientRect(),i=window.innerWidth,a=e.left+e.width/2-o/2;a=Math.max(n,Math.min(a,i-o-n));let c=Math.min(Math.max(e.left+e.width/2-a,14),o-14),d=e.top-r<70;l({top:d?e.bottom+s:e.top-s,left:a,arrowLeft:c,below:d})},[t,o,n,r,s]);return(0,i.useLayoutEffect)(()=>{e&&d()},[e,d]),(0,i.useEffect)(()=>{if(e)return window.addEventListener("scroll",d,{passive:!0,capture:!0}),window.addEventListener("resize",d,{passive:!0}),()=>{window.removeEventListener("scroll",d,{capture:!0}),window.removeEventListener("resize",d)}},[e,d]),a}let d="invictus-tooltip-activate";function p(t){let[e,o]=(0,i.useState)(!1),[n,r]=(0,i.useState)(!1),[a,l]=(0,i.useState)(!1),[c,p]=(0,i.useState)(!1),u=(0,i.useRef)(null),f=(0,i.useRef)(`tip-${Math.random()}`),m=e||n||a||c,h=(0,i.useCallback)(()=>{clearTimeout(u.current),o(!1),r(!1),l(!1),p(!1)},[]),v=(0,i.useCallback)(()=>{document.dispatchEvent(new CustomEvent(d,{detail:{id:f.current}}))},[]);return s(()=>{if(!m)return;let t=t=>{t.detail.id!==f.current&&h()};return document.addEventListener(d,t),()=>document.removeEventListener(d,t)},[m,h]),(0,i.useEffect)(()=>{if(!m)return;let e=t=>{"Escape"===t.key&&h()},o=e=>{let o=t.current&&t.current.contains(e.target),n=e.target.closest?.(".invictus-tooltip");o||n||h()};return document.addEventListener("keydown",e),document.addEventListener("mousedown",o),()=>{document.removeEventListener("keydown",e),document.removeEventListener("mousedown",o)}},[m,h,t]),(0,i.useEffect)(()=>()=>clearTimeout(u.current),[]),{visible:m,pinned:c,onMouseEnter:()=>{clearTimeout(u.current),o(!0),v()},onMouseLeave:()=>{u.current=setTimeout(()=>o(!1),150)},onFocus:()=>{l(!0),v()},onBlur:()=>l(!1),onClick:()=>p(t=>!t),onTooltipMouseEnter:()=>{clearTimeout(u.current),r(!0)},onTooltipMouseLeave:()=>r(!1),pin:(0,i.useCallback)(()=>p(!0),[p])}}var u=o(6370),f=o(4846);function m(){return b({title:"Only Admins",tooltip:"Only available for users with a **System Admin** role."})}function h(){return b({title:"Requires Operator",tooltip:"Only available for users with at least **Operator** permissions on the flow."})}function v(){return b({title:"Only Admins",tooltip:"Only available for users with a **Folder** or **System Admin** role."})}function g({version:t}){return b({title:`New since ${t}`,tooltip:`Feature included since **Invictus ${t}**.`,backgroundColor:"#059669",color:"white"})}function b({title:t,tooltip:e,backgroundColor:o="#b55d00",color:s="white"}){l();let a=(0,i.useRef)(null),d=(0,i.useId)(),{visible:m,pinned:h,onMouseEnter:v,onMouseLeave:g,onFocus:x,onBlur:w,onClick:y,onTooltipMouseEnter:j,onTooltipMouseLeave:k}=p(a),E=c(a,m,{tooltipWidth:260}),A=m&&(0,r.createPortal)((0,n.jsxs)("div",{id:d,role:"tooltip",className:`invictus-tooltip${h?" invictus-tooltip--pinned":""}`,"data-below":E.below?"true":"false",onMouseEnter:j,onMouseLeave:k,style:{position:"fixed",top:E.below?E.top:"auto",bottom:E.below?"auto":`calc(100vh - ${E.top}px)`,left:E.left,width:260,"--tooltip-accent":o},children:["string"==typeof e?(0,n.jsx)(u.oz,{remarkPlugins:[f.A],children:e}):e,(0,n.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:E.arrowLeft}})]}),document.body);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("span",{ref:a,style:{position:"relative",display:"inline-block",marginLeft:"8px",textTransform:"none",fontWeight:"bold"},role:"button","aria-pressed":h,"aria-describedby":m?d:void 0,onMouseEnter:v,onMouseLeave:g,onFocus:x,onBlur:w,onClick:y,children:(0,n.jsx)("span",{tabIndex:0,className:"invictus-badge",style:{backgroundColor:o,color:s,padding:"2px 6px",borderRadius:"4px",fontSize:"1rem",fontWeight:"600",fontFamily:"Bitter",cursor:"help",userSelect:"none",borderBottom:"1.5px dotted currentColor","--badge-accent":o},children:t})}),A]})}let x="#0b6369";function w(){l();let t=(0,i.useRef)(null),e=(0,i.useId)(),{visible:o,pinned:s,onMouseEnter:a,onMouseLeave:d,onFocus:u,onBlur:f,onClick:m,onTooltipMouseEnter:h,onTooltipMouseLeave:v}=p(t),g=c(t,o,{tooltipWidth:260}),b=o&&(0,r.createPortal)((0,n.jsxs)("div",{id:e,role:"tooltip",className:`invictus-tooltip${s?" invictus-tooltip--pinned":""}`,"data-below":g.below?"true":"false",onMouseEnter:h,onMouseLeave:v,style:{position:"fixed",top:g.below?g.top:"auto",bottom:g.below?"auto":`calc(100vh - ${g.top}px)`,left:g.left,width:260,"--tooltip-accent":x},children:["Same for both ",(0,n.jsx)("strong",{children:"Dashboard"})," and ",(0,n.jsx)("strong",{children:"Framework"}),". Can be skipped if done already.",(0,n.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:g.arrowLeft}})]}),document.body);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("span",{ref:t,style:{position:"relative",display:"inline-block",marginLeft:"8px",textTransform:"none",fontWeight:"bold"},children:(0,n.jsx)("span",{tabIndex:0,role:"button","aria-pressed":s,"aria-describedby":o?e:void 0,onMouseEnter:a,onMouseLeave:d,onFocus:u,onBlur:f,onClick:m,className:"invictus-badge",style:{backgroundColor:"#e0f7f7",color:x,padding:"2px 6px",borderRadius:"4px",fontSize:"1rem",fontWeight:"600",fontFamily:"Bitter",cursor:"help",userSelect:"none",outline:"none",borderBottom:"1.5px dotted currentColor","--badge-accent":x},children:"Shared"})}),b]})}},8453(t,e,o){o.d(e,{R:()=>s,x:()=>a});var n=o(6540);let i={},r=n.createContext(i);function s(t){let e=n.useContext(r);return n.useMemo(function(){return"function"==typeof t?t(e):{...e,...t}},[e,t])}function a(t){let e;return e=t.disableParentContext?"function"==typeof t.components?t.components(i):t.components||i:s(t.components),n.createElement(r.Provider,{value:e},t.children)}}}]);