...
`;function l(){(0,i.useInsertionEffect)(()=>{let t="invictus-tooltip-styles",e=document.getElementById(t);e||((e=document.createElement("style")).id=t,document.head.appendChild(e)),e.textContent=s},[])}function c(t,e,{tooltipWidth:o=300,margin:n=12,navHeight:r=60,gap:a=10}={}){let[s,l]=(0,i.useState)({top:0,left:0,arrowLeft:14,below:!1}),d=(0,i.useCallback)(()=>{if(!t.current)return;let e=t.current.getBoundingClientRect(),i=window.innerWidth,s=e.left+e.width/2-o/2;s=Math.max(n,Math.min(s,i-o-n));let c=Math.min(Math.max(e.left+e.width/2-s,14),o-14),d=e.top-r<70;l({top:d?e.bottom+a:e.top-a,left:s,arrowLeft:c,below:d})},[t,o,n,r,a]);return(0,i.useLayoutEffect)(()=>{e&&d()},[e,d]),(0,i.useEffect)(()=>{if(e)return window.addEventListener("scroll",d,{passive:!0,capture:!0}),window.addEventListener("resize",d,{passive:!0}),()=>{window.removeEventListener("scroll",d,{capture:!0}),window.removeEventListener("resize",d)}},[e,d]),s}let d="invictus-tooltip-activate";function p(t){let[e,o]=(0,i.useState)(!1),[n,r]=(0,i.useState)(!1),[s,l]=(0,i.useState)(!1),[c,p]=(0,i.useState)(!1),u=(0,i.useRef)(null),m=(0,i.useRef)(`tip-${Math.random()}`),f=e||n||s||c,h=(0,i.useCallback)(()=>{clearTimeout(u.current),o(!1),r(!1),l(!1),p(!1)},[]),v=(0,i.useCallback)(()=>{document.dispatchEvent(new CustomEvent(d,{detail:{id:m.current}}))},[]);return a(()=>{if(!f)return;let t=t=>{t.detail.id!==m.current&&h()};return document.addEventListener(d,t),()=>document.removeEventListener(d,t)},[f,h]),(0,i.useEffect)(()=>{if(!f)return;let e=t=>{"Escape"===t.key&&h()},o=e=>{let o=t.current&&t.current.contains(e.target),n=e.target.closest?.(".invictus-tooltip");o||n||h()};return document.addEventListener("keydown",e),document.addEventListener("mousedown",o),()=>{document.removeEventListener("keydown",e),document.removeEventListener("mousedown",o)}},[f,h,t]),(0,i.useEffect)(()=>()=>clearTimeout(u.current),[]),{visible:f,pinned:c,onMouseEnter:()=>{clearTimeout(u.current),o(!0),v()},onMouseLeave:()=>{u.current=setTimeout(()=>o(!1),150)},onFocus:()=>{l(!0),v()},onBlur:()=>l(!1),onClick:()=>p(t=>!t),onTooltipMouseEnter:()=>{clearTimeout(u.current),r(!0)},onTooltipMouseLeave:()=>r(!1),pin:(0,i.useCallback)(()=>p(!0),[p])}}var u=o(6370),m=o(4846);function f(){return x({title:"Only Admins",tooltip:"Only available for users with a **System Admin** role."})}function h(){return x({title:"Requires Operator",tooltip:"Only available for users with at least **Operator** permissions on the flow."})}function v(){return x({title:"Only Admins",tooltip:"Only available for users with a **Folder** or **System Admin** role."})}function g({version:t,style:e}){return x({title:`New since ${t}`,tooltip:`Feature included since **Invictus ${t}**.`,backgroundColor:"var(--inv-badge-new-bg)",color:"var(--inv-badge-new-text)",style:e})}function b({version:t,note:e,style:o}){return x({title:`Deprecated since ${t}`,tooltip:`Feature deprecated since **Invictus ${t}**. ${e}`,backgroundColor:"var(--inv-badge-deprecated-bg)",color:"var(--inv-badge-deprecated-text)",style:o})}function x({title:t,tooltip:e,backgroundColor:o="#b55d00",color:a="white",style:s}){l();let d=(0,i.useRef)(null),f=(0,i.useId)(),{visible:h,pinned:v,onMouseEnter:g,onMouseLeave:b,onFocus:w,onBlur:y,onClick:j,onTooltipMouseEnter:k,onTooltipMouseLeave:E}=p(d),A=c(d,h,{tooltipWidth:260}),F=h&&(0,r.createPortal)((0,n.jsxs)("div",{id:f,role:"tooltip",className:`invictus-tooltip${v?" invictus-tooltip--pinned":""}`,"data-below":A.below?"true":"false",onMouseEnter:k,onMouseLeave:E,style:{position:"fixed",top:A.below?A.top:"auto",bottom:A.below?"auto":`calc(100vh - ${A.top}px)`,left:A.left,width:260,"--tooltip-accent":o},children:["string"==typeof e?(0,n.jsx)(u.oz,{remarkPlugins:[m.A],children:e}):e,(0,n.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:A.arrowLeft}})]}),document.body);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("span",{ref:d,style:{position:"relative",display:"inline-block",marginLeft:"8px",textTransform:"none",fontWeight:"normal",...s},role:"button","aria-pressed":v,"aria-describedby":h?f:void 0,onMouseEnter:g,onMouseLeave:b,onFocus:w,onBlur:y,onClick:j,children:(0,n.jsx)("span",{tabIndex:0,className:"invictus-badge",style:{backgroundColor:o,color:a,padding:"2px 6px",borderRadius:"4px",fontSize:"0.9rem",fontWeight:"600",fontFamily:"Inter",cursor:"help",userSelect:"none",borderBottom:"1.5px dotted currentColor","--badge-accent":o,...s},children:t})}),F]})}let w="var(--inv-badge-shared-accent)";function y(){l();let t=(0,i.useRef)(null),e=(0,i.useId)(),{visible:o,pinned:a,onMouseEnter:s,onMouseLeave:d,onFocus:u,onBlur:m,onClick:f,onTooltipMouseEnter:h,onTooltipMouseLeave:v}=p(t),g=c(t,o,{tooltipWidth:260}),b=o&&(0,r.createPortal)((0,n.jsxs)("div",{id:e,role:"tooltip",className:`invictus-tooltip${a?" invictus-tooltip--pinned":""}`,"data-below":g.below?"true":"false",onMouseEnter:h,onMouseLeave:v,style:{position:"fixed",top:g.below?g.top:"auto",bottom:g.below?"auto":`calc(100vh - ${g.top}px)`,left:g.left,width:260,"--tooltip-accent":w},children:["Same for both ",(0,n.jsx)("strong",{children:"Dashboard"})," and ",(0,n.jsx)("strong",{children:"Framework"}),". Can be skipped if done already.",(0,n.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:g.arrowLeft}})]}),document.body);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("span",{ref:t,style:{position:"relative",display:"inline-block",marginLeft:"8px",textTransform:"none",fontWeight:"bold"},children:(0,n.jsx)("span",{tabIndex:0,role:"button","aria-pressed":a,"aria-describedby":o?e:void 0,onMouseEnter:s,onMouseLeave:d,onFocus:u,onBlur:m,onClick:f,className:"invictus-badge",style:{backgroundColor:"var(--inv-badge-shared-bg)",color:"var(--inv-badge-shared-text)",padding:"2px 6px",borderRadius:"4px",fontSize:"0.9rem",fontWeight:"600",fontFamily:"Inter",cursor:"help",userSelect:"none",outline:"none",borderBottom:"1.5px dotted currentColor","--badge-accent":w},children:"Shared"})}),b]})}},8453(t,e,o){o.d(e,{R:()=>a,x:()=>s});var n=o(6540);let i={},r=n.createContext(i);function a(t){let e=n.useContext(r);return n.useMemo(function(){return"function"==typeof t?t(e):{...e,...t}},[e,t])}function s(t){let e;return e=t.disableParentContext?"function"==typeof t.components?t.components(i):t.components||i:a(t.components),n.createElement(r.Provider,{value:e},t.children)}}}]);