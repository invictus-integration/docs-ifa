...
`;function l(){(0,n.useInsertionEffect)(()=>{let e="invictus-tooltip-styles",t=document.getElementById(e);t||((t=document.createElement("style")).id=e,document.head.appendChild(t)),t.textContent=s},[])}function c(e,t,{tooltipWidth:o=300,margin:i=12,navHeight:r=60,gap:a=10}={}){let[s,l]=(0,n.useState)({top:0,left:0,arrowLeft:14,below:!1}),d=(0,n.useCallback)(()=>{if(!e.current)return;let t=e.current.getBoundingClientRect(),n=window.innerWidth,s=t.left+t.width/2-o/2;s=Math.max(i,Math.min(s,n-o-i));let c=Math.min(Math.max(t.left+t.width/2-s,14),o-14),d=t.top-r<70;l({top:d?t.bottom+a:t.top-a,left:s,arrowLeft:c,below:d})},[e,o,i,r,a]);return(0,n.useLayoutEffect)(()=>{t&&d()},[t,d]),(0,n.useEffect)(()=>{if(t)return window.addEventListener("scroll",d,{passive:!0,capture:!0}),window.addEventListener("resize",d,{passive:!0}),()=>{window.removeEventListener("scroll",d,{capture:!0}),window.removeEventListener("resize",d)}},[t,d]),s}let d="invictus-tooltip-activate";function u(e){let[t,o]=(0,n.useState)(!1),[i,r]=(0,n.useState)(!1),[s,l]=(0,n.useState)(!1),[c,u]=(0,n.useState)(!1),p=(0,n.useRef)(null),m=(0,n.useRef)(`tip-${Math.random()}`),f=t||i||s||c,h=(0,n.useCallback)(()=>{clearTimeout(p.current),o(!1),r(!1),l(!1),u(!1)},[]),b=(0,n.useCallback)(()=>{document.dispatchEvent(new CustomEvent(d,{detail:{id:m.current}}))},[]);return a(()=>{if(!f)return;let e=e=>{e.detail.id!==m.current&&h()};return document.addEventListener(d,e),()=>document.removeEventListener(d,e)},[f,h]),(0,n.useEffect)(()=>{if(!f)return;let t=e=>{"Escape"===e.key&&h()},o=t=>{let o=e.current&&e.current.contains(t.target),i=t.target.closest?.(".invictus-tooltip");o||i||h()};return document.addEventListener("keydown",t),document.addEventListener("mousedown",o),()=>{document.removeEventListener("keydown",t),document.removeEventListener("mousedown",o)}},[f,h,e]),(0,n.useEffect)(()=>()=>clearTimeout(p.current),[]),{visible:f,pinned:c,onMouseEnter:()=>{clearTimeout(p.current),o(!0),b()},onMouseLeave:()=>{p.current=setTimeout(()=>o(!1),150)},onFocus:()=>{l(!0),b()},onBlur:()=>l(!1),onClick:()=>u(e=>!e),onTooltipMouseEnter:()=>{clearTimeout(p.current),r(!0)},onTooltipMouseLeave:()=>r(!1),pin:(0,n.useCallback)(()=>u(!0),[u])}}var p=o(6370),m=o(4846);function f(){return x({title:"Only Admins",tooltip:"Only available for users with a **System Admin** role."})}function h(){return x({title:"Requires Operator",tooltip:"Only available for users with at least **Operator** permissions on the flow."})}function b(){return x({title:"Only Admins",tooltip:"Only available for users with a **Folder** or **System Admin** role."})}function v({version:e}){return x({title:`New since ${e}`,tooltip:`Feature included since **Invictus ${e}**.`,backgroundColor:"#059669",color:"white"})}function x({title:e,tooltip:t,backgroundColor:o="#b55d00",color:a="white"}){l();let s=(0,n.useRef)(null),d=(0,n.useId)(),{visible:f,pinned:h,onMouseEnter:b,onMouseLeave:v,onFocus:g,onBlur:w,onClick:y,onTooltipMouseEnter:k,onTooltipMouseLeave:j}=u(s),E=c(s,f,{tooltipWidth:260}),L=f&&(0,r.createPortal)((0,i.jsxs)("div",{id:d,role:"tooltip",className:`invictus-tooltip${h?" invictus-tooltip--pinned":""}`,"data-below":E.below?"true":"false",onMouseEnter:k,onMouseLeave:j,style:{position:"fixed",top:E.below?E.top:"auto",bottom:E.below?"auto":`calc(100vh - ${E.top}px)`,left:E.left,width:260,"--tooltip-accent":o},children:["string"==typeof t?(0,i.jsx)(p.oz,{remarkPlugins:[m.A],children:t}):t,(0,i.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:E.arrowLeft}})]}),document.body);return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("span",{ref:s,style:{position:"relative",display:"inline-block",marginLeft:"8px",textTransform:"none",fontWeight:"bold"},role:"button","aria-pressed":h,"aria-describedby":f?d:void 0,onMouseEnter:b,onMouseLeave:v,onFocus:g,onBlur:w,onClick:y,children:(0,i.jsx)("span",{tabIndex:0,className:"invictus-badge",style:{backgroundColor:o,color:a,padding:"2px 6px",borderRadius:"4px",fontSize:"1rem",fontWeight:"600",fontFamily:"Bitter",cursor:"help",userSelect:"none",borderBottom:"1.5px dotted currentColor","--badge-accent":o},children:e})}),L]})}let g="#0b6369";function w(){l();let e=(0,n.useRef)(null),t=(0,n.useId)(),{visible:o,pinned:a,onMouseEnter:s,onMouseLeave:d,onFocus:p,onBlur:m,onClick:f,onTooltipMouseEnter:h,onTooltipMouseLeave:b}=u(e),v=c(e,o,{tooltipWidth:260}),x=o&&(0,r.createPortal)((0,i.jsxs)("div",{id:t,role:"tooltip",className:`invictus-tooltip${a?" invictus-tooltip--pinned":""}`,"data-below":v.below?"true":"false",onMouseEnter:h,onMouseLeave:b,style:{position:"fixed",top:v.below?v.top:"auto",bottom:v.below?"auto":`calc(100vh - ${v.top}px)`,left:v.left,width:260,"--tooltip-accent":g},children:["Same for both ",(0,i.jsx)("strong",{children:"Dashboard"})," and ",(0,i.jsx)("strong",{children:"Framework"}),". Can be skipped if done already.",(0,i.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:v.arrowLeft}})]}),document.body);return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("span",{ref:e,style:{position:"relative",display:"inline-block",marginLeft:"8px",textTransform:"none",fontWeight:"bold"},children:(0,i.jsx)("span",{tabIndex:0,role:"button","aria-pressed":a,"aria-describedby":o?t:void 0,onMouseEnter:s,onMouseLeave:d,onFocus:p,onBlur:m,onClick:f,className:"invictus-badge",style:{backgroundColor:"#e0f7f7",color:g,padding:"2px 6px",borderRadius:"4px",fontSize:"1rem",fontWeight:"600",fontFamily:"Bitter",cursor:"help",userSelect:"none",outline:"none",borderBottom:"1.5px dotted currentColor","--badge-accent":g},children:"Shared"})}),x]})}},4050(e,t,o){o.d(t,{A:()=>r});var i=o(4848);o(6540);function n(){return(0,i.jsx)("span",{className:"separator_qLva","aria-hidden":"true",children:(0,i.jsx)("svg",{width:"10",height:"10",viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,i.jsx)("path",{d:"M4.5 2.5L8 6L4.5 9.5",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})}function r({paths:e,items:t,activeLast:o=!0}){let a=e??t??[];return(0,i.jsxs)("nav",{className:"nav_sYHQ","aria-label":"Breadcrumb",children:[(0,i.jsx)("span",{className:"logo_Er0S",children:(0,i.jsx)("img",{src:"/img/favicon.ico",alt:""})}),(0,i.jsx)("ol",{className:"list_yxgx",children:a.map((e,t)=>{let r=t===a.length-1,s=o&&r;return(0,i.jsxs)("li",{className:"listItem_qpim",children:[t>0&&(0,i.jsx)(n,{}),(0,i.jsx)("span",{className:`item_gLbu${s?" active_Ij2Z":""}`,...s?{"aria-current":"page"}:{},children:e})]},t)})})]})}},8453(e,t,o){o.d(t,{R:()=>a,x:()=>s});var i=o(6540);let n={},r=i.createContext(n);function a(e){let t=i.useContext(r);return i.useMemo(function(){return"function"==typeof e?e(t):{...t,...e}},[t,e])}function s(e){let t;return t=e.disableParentContext?"function"==typeof e.components?e.components(n):e.components||n:a(e.components),i.createElement(r.Provider,{value:t},e.children)}}}]);