...
Once imported, messages become visible and searchable in the flow monitoring view.`}},u=["flow","flow-trace","flow-trace-importing"];function p({termKey:e,label:t,termClass:r,tooltipMarkdown:f,variant:m="technical"}){(0,l.n9)(),(0,o.useInsertionEffect)(()=>{let e="term-highlight-styles",t=document.getElementById(e);t||((t=document.createElement("style")).id=e,document.head.appendChild(t)),t.textContent=d},[]);let{colorMode:g}=(0,c.G)(),x="dark"===g,b=(0,o.useRef)(null),v=(0,o.useId)(),{visible:w,pinned:j,onMouseEnter:y,onMouseLeave:k,onFocus:_,onBlur:A,onClick:C,pin:E,onTooltipMouseEnter:T,onTooltipMouseLeave:I}=(0,l.DV)(b),M=(0,l._W)(b,w,{tooltipWidth:300}),[N,L]=(0,o.useState)(e);(0,o.useEffect)(()=>{w||L(e)},[w,e]);let z=u.indexOf(N),D=u[(z-1+u.length)%u.length],F=u[(z+1)%u.length],S=h[N],B=N===e?f:S.tooltipMarkdown,R=w&&(0,i.createPortal)((0,n.jsxs)("div",{id:v,role:"tooltip",className:`invictus-tooltip${j?" invictus-tooltip--pinned":""}`,"data-below":M.below?"true":"false",onMouseEnter:T,onMouseLeave:I,style:{position:"fixed",top:M.below?M.top:"auto",bottom:M.below?"auto":`calc(100vh - ${M.top}px)`,left:M.left,width:300,"--tooltip-accent":x?S.accentDark:S.accent},children:["technical"===m&&(0,n.jsxs)("div",{className:"invictus-tooltip__nav",children:[(0,n.jsx)("button",{className:"invictus-tooltip__nav-btn",onClick:e=>{e.stopPropagation(),E(),L(D)},"aria-label":`Previous: ${h[D].label}`,children:"\u2039"}),(0,n.jsxs)("span",{className:"invictus-tooltip__nav-label",children:[S.label,(0,n.jsxs)("span",{className:"invictus-tooltip__nav-pager",children:[z+1," / ",u.length]})]}),(0,n.jsx)("button",{className:"invictus-tooltip__nav-btn",onClick:e=>{e.stopPropagation(),E(),L(F)},"aria-label":`Next: ${h[F].label}`,children:"\u203A"})]}),(0,n.jsx)(s.oz,{remarkPlugins:[a.A],components:{a:({href:e,children:t})=>{let r=e?.startsWith("#")?e.slice(1):null,o=r?h[r]:null;return o?(0,n.jsx)("button",{className:"invictus-tooltip__term-link",style:{color:x?o.accentDark:o.accent,borderBottomColor:x?o.accentDark:o.accent},onClick:e=>{e.stopPropagation(),E(),L(r)},children:t}):(0,n.jsx)("a",{href:e,children:t})}},children:B}),(0,n.jsx)("span",{className:"invictus-tooltip__arrow",style:{left:M.arrowLeft}})]}),document.body);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)("span",{ref:b,className:`term-highlight ${r}`,tabIndex:0,role:"button","aria-pressed":j,"aria-describedby":w?v:void 0,onMouseEnter:y,onMouseLeave:k,onFocus:_,onBlur:A,onClick:C,children:[t,(0,n.jsx)("span",{className:"term-highlight__icon","aria-hidden":"true",children:"?"})]}),R]})}let f=`A **Flow** is a named message chain \u{2014} a logical grouping of related **mapping messages** sharing a common integration origin.
