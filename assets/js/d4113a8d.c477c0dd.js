...
`;function s(){(0,n.useInsertionEffect)(()=>{let t="invictus-tooltip-styles",e=document.getElementById(t);e||((e=document.createElement("style")).id=t,document.head.appendChild(e)),e.textContent=r},[])}function a(t,e,{tooltipWidth:o=300,margin:i=12,navHeight:r=60,gap:s=10}={}){let[l,c]=(0,n.useState)({top:0,left:0,arrowLeft:14,below:!1}),p=(0,n.useCallback)(()=>{if(!t.current)return;let e=t.current.getBoundingClientRect(),n=window.innerWidth,a=e.left+e.width/2-o/2;a=Math.max(i,Math.min(a,n-o-i));let l=Math.min(Math.max(e.left+e.width/2-a,14),o-14),p=e.top-r<70;c({top:p?e.bottom+s:e.top-s,left:a,arrowLeft:l,below:p})},[t,o,i,r,s]);return(0,n.useLayoutEffect)(()=>{e&&p()},[e,p]),(0,n.useEffect)(()=>{if(e)return window.addEventListener("scroll",p,{passive:!0,capture:!0}),window.addEventListener("resize",p,{passive:!0}),()=>{window.removeEventListener("scroll",p,{capture:!0}),window.removeEventListener("resize",p)}},[e,p]),l}let l="invictus-tooltip-activate";function c(t){let[e,o]=(0,n.useState)(!1),[r,s]=(0,n.useState)(!1),[a,c]=(0,n.useState)(!1),[p,u]=(0,n.useState)(!1),d=(0,n.useRef)(null),f=(0,n.useRef)(`tip-${Math.random()}`),m=e||r||a||p,h=(0,n.useCallback)(()=>{clearTimeout(d.current),o(!1),s(!1),c(!1),u(!1)},[]),v=(0,n.useCallback)(()=>{document.dispatchEvent(new CustomEvent(l,{detail:{id:f.current}}))},[]);return i(()=>{if(!m)return;let t=t=>{t.detail.id!==f.current&&h()};return document.addEventListener(l,t),()=>document.removeEventListener(l,t)},[m,h]),(0,n.useEffect)(()=>{if(!m)return;let e=t=>{"Escape"===t.key&&h()},o=e=>{let o=t.current&&t.current.contains(e.target),n=e.target.closest?.(".invictus-tooltip");o||n||h()};return document.addEventListener("keydown",e),document.addEventListener("mousedown",o),()=>{document.removeEventListener("keydown",e),document.removeEventListener("mousedown",o)}},[m,h,t]),(0,n.useEffect)(()=>()=>clearTimeout(d.current),[]),{visible:m,pinned:p,onMouseEnter:()=>{clearTimeout(d.current),o(!0),v()},onMouseLeave:()=>{d.current=setTimeout(()=>o(!1),150)},onFocus:()=>{c(!0),v()},onBlur:()=>c(!1),onClick:()=>u(t=>!t),onTooltipMouseEnter:()=>{clearTimeout(d.current),s(!0)},onTooltipMouseLeave:()=>s(!1),pin:(0,n.useCallback)(()=>u(!0),[u])}}},8453(t,e,o){o.d(e,{R:()=>s,x:()=>a});var n=o(6540);let i={},r=n.createContext(i);function s(t){let e=n.useContext(r);return n.useMemo(function(){return"function"==typeof t?t(e):{...e,...t}},[e,t])}function a(t){let e;return e=t.disableParentContext?"function"==typeof t.components?t.components(i):t.components||i:s(t.components),n.createElement(r.Provider,{value:e},t.children)}}}]);