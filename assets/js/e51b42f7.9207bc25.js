...
`;function a(){(0,o.useInsertionEffect)(()=>{let t="invictus-tooltip-styles",e=document.getElementById(t);e||((e=document.createElement("style")).id=t,document.head.appendChild(e)),e.textContent=r},[])}function s(t,e,{tooltipWidth:i=300,margin:n=12,navHeight:r=60,gap:a=10}={}){let[l,c]=(0,o.useState)({top:0,left:0,arrowLeft:14,below:!1}),d=(0,o.useCallback)(()=>{if(!t.current)return;let e=t.current.getBoundingClientRect(),o=window.innerWidth,s=e.left+e.width/2-i/2;s=Math.max(n,Math.min(s,o-i-n));let l=Math.min(Math.max(e.left+e.width/2-s,14),i-14),d=e.top-r<70;c({top:d?e.bottom+a:e.top-a,left:s,arrowLeft:l,below:d})},[t,i,n,r,a]);return(0,o.useLayoutEffect)(()=>{e&&d()},[e,d]),(0,o.useEffect)(()=>{if(e)return window.addEventListener("scroll",d,{passive:!0,capture:!0}),window.addEventListener("resize",d,{passive:!0}),()=>{window.removeEventListener("scroll",d,{capture:!0}),window.removeEventListener("resize",d)}},[e,d]),l}let l="invictus-tooltip-activate";function c(t){let[e,i]=(0,o.useState)(!1),[r,a]=(0,o.useState)(!1),[s,c]=(0,o.useState)(!1),[d,u]=(0,o.useState)(!1),p=(0,o.useRef)(null),m=(0,o.useRef)(`tip-${Math.random()}`),h=e||r||s||d,f=(0,o.useCallback)(()=>{clearTimeout(p.current),i(!1),a(!1),c(!1),u(!1)},[]),v=(0,o.useCallback)(()=>{document.dispatchEvent(new CustomEvent(l,{detail:{id:m.current}}))},[]);return n(()=>{if(!h)return;let t=t=>{t.detail.id!==m.current&&f()};return document.addEventListener(l,t),()=>document.removeEventListener(l,t)},[h,f]),(0,o.useEffect)(()=>{if(!h)return;let e=t=>{"Escape"===t.key&&f()},i=e=>{let i=t.current&&t.current.contains(e.target),o=e.target.closest?.(".invictus-tooltip");i||o||f()};return document.addEventListener("keydown",e),document.addEventListener("mousedown",i),()=>{document.removeEventListener("keydown",e),document.removeEventListener("mousedown",i)}},[h,f,t]),(0,o.useEffect)(()=>()=>clearTimeout(p.current),[]),{visible:h,pinned:d,onMouseEnter:()=>{clearTimeout(p.current),i(!0),v()},onMouseLeave:()=>{p.current=setTimeout(()=>i(!1),150)},onFocus:()=>{c(!0),v()},onBlur:()=>c(!1),onClick:()=>u(t=>!t),onTooltipMouseEnter:()=>{clearTimeout(p.current),a(!0)},onTooltipMouseLeave:()=>a(!1),pin:(0,o.useCallback)(()=>u(!0),[u])}}},8453(t,e,i){i.d(e,{R:()=>a,x:()=>s});var o=i(6540);let n={},r=o.createContext(n);function a(t){let e=o.useContext(r);return o.useMemo(function(){return"function"==typeof t?t(e):{...e,...t}},[e,t])}function s(t){let e;return e=t.disableParentContext?"function"==typeof t.components?t.components(n):t.components||n:a(t.components),o.createElement(r.Provider,{value:e},t.children)}}}]);